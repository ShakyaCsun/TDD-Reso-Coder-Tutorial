...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      test(
        'should return remote data when the call to remote data source is a success',
        () async {
          // arrange
      ...
      test(
        'should cache the data locally when the call to remote data source is a success',
        () async {
          // arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(any))
              .thenAnswer((_) async => tNumberTriviaModel);
